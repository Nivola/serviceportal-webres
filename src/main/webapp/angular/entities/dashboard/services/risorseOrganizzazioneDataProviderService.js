 ...
 * =========================LICENSE_END==================================
 */
nivolaApp.service( 'risorseOrganizzazioneDataProviderService',
    ...
    service.provide = function(widget) {
		...
		widget.loadData = function() {
			...
			var entity = entitiesRest.getEntity('dashboardOrganizzazioneRisorse');
    		entity.get({'id':utente.abilitazioneSelezionata.orgUuid}).$promise
                .then(function(data) {
					temp = {
						computeService : {
							isActive : false,
                    ...
                    // Divisioni
                    temp.numeroDivisioni = data.numeroDivisioni;
					// Accounts
