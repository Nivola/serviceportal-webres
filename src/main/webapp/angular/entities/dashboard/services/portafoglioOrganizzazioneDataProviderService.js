 ...
 * =========================LICENSE_END==================================
 */
nivolaApp.service( 'portafoglioOrganizzazioneDataProviderService',
    ...
    service.provide = function(widget) {
		...
		widget.loadData = function() {
			...
			var entity = entitiesRest.getEntity('dashboardOrganizzazioneCosti');
    		return entity.get({'id':utente.abilitazioneSelezionata.orgUuid, 'anno': dataCorrente.getFullYear()}).$promise
                .then(function(data) {
                    temp = {
