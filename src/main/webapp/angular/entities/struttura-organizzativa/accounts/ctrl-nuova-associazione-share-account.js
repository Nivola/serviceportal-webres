 ...
 * =========================LICENSE_END==================================
 */
nivolaApp.controller('NuovaAssociazioneShareAccountController', [
        ...
        $scope.actions = {
            ...
            salva: function (event) {
				...
				NewSharesNetapps.save(jsonData, function (data) {
                    notificationManager.showSuccessPopup($translate.instant('accounts.shares.nuova.success'));
                    resetForm();
                    history.back();
                }, function (err) {
                    if(err && err.data && err.data.messaggio)
					    notificationManager.showErrorPopup($translate.instant('accounts.shares.nuova.error') + '<br>' + err.data.messaggio);
                    else notificationManager.showErrorPopup($translate.instant('accounts.shares.nuova.error'));
